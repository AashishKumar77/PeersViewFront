...
@Component({
  selector: 'app-scholarship-filter-modal',
  templateUrl: './scholarship-filter-modal.component.html',
  styleUrls: ['./scholarship-filter-modal.component.scss']
})
export class ScholarshipFilterDialogComponent implements OnInit {
