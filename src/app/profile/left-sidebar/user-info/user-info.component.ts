...
export class ProfileLeftSidebarUserInfoComponent {
  ...
  public ngOnInit (): void {
    this.followed = this.user ? this.user.isAlreadyFollowed : false;
    this.isVerified = this.user ? this.user.connectionVerified : false;
    if (this.followed && this.isVerified) {
      this.followStatus = 'Connected';
    } else if (this.followed && !this.isVerified) {
